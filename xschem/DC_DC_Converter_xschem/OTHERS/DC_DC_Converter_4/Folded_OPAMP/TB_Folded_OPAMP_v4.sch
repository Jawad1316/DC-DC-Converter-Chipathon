...
C {devices/vsource.sym} 110 -220 0 0 {name=V1 value=1.8}
C {devices/gnd.sym} 110 -190 0 0 {name=l18 lab=GND}
C {devices/lab_wire.sym} 110 -280 0 0 {name=l6 sig_type=std_logic lab=VDD}
C {devices/vsource.sym} 200 -220 0 0 {name=V5 value=0}
C {devices/gnd.sym} 200 -190 0 0 {name=l26 lab=GND}
C {devices/lab_wire.sym} 200 -260 0 0 {name=l7 sig_type=std_logic lab=VSS}
...
C {devices/vsource.sym} 160 -60 0 0 {name=V2 value=0.9}
...
.endc
" }
C {DC_DC_Converter_vf/Folded_OPAMP/Folded_OPAMP_v4.sym} 610 -100 0 0 {name=x1}
