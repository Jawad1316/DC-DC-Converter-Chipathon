...
C {devices/isource.sym} 1330 -20 2 1 {name=I1 value=50u}
C {devices/lab_wire.sym} 1330 -70 0 0 {name=l25 sig_type=std_logic lab=IBIAS2}
...
C {devices/lab_wire.sym} 1400 700 0 0 {name=l64 sig_type=std_logic lab=out}
...
C {devices/lab_wire.sym} 1330 50 0 0 {name=l24 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/revised_delay-block/delay_block_with_less_delay_for_symbol.sym} 770 1580 0 0 {name=X4}
C {DC_DC_Converter/revised_delay-block/delay_block_with_less_delay_for_symbol.sym} 1110 1870 0 0 {name=X8}
...
C {devices/lab_pin.sym} 2410 670 0 1 {name=l74 sig_type=std_logic lab=VSS}
...
C {DC_DC_Converter/Comparator/comp_lvt_current_mirror.sym} 480 510 0 1 {}
