...
"
spice_ignore=false}
C {devices/opin.sym} 440 20 0 0 {name=p1 lab=VOUT_P}
C {DC_DC_Converter/Inverter_4/Inverter4.sym} 220 30 0 0 {name=X1}
C {devices/opin.sym} 440 40 0 0 {name=p2 lab=VOUT_N}
