...
"
spice_ignore=false}
C {devices/code_shown.sym} -87.5 -65 0 0 {name=NGSPICE
only_toplevel=true
value="
...
C {devices/vsource.sym} -960 -385 0 0 {name=V8 value=1.8}
...
C {devices/lab_wire.sym} -537.5 -160 0 0 {name=l8 sig_type=std_logic lab=VDD}
