...
C {devices/lab_pin.sym} 890 -760 1 0 {name=l3 sig_type=std_logic lab=in+}
C {devices/lab_pin.sym} 890 -740 3 0 {name=l4 sig_type=std_logic lab=in-}
...
C {DC_DC_Converter/Comparator/Comparator.sym} 740 -610 0 0 {name=XM1}
