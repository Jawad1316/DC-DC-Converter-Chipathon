...
N 2100 620 2200 620 {
lab=Q}
N 2125 890 2125 917.5 {
lab=VSS}
N 2125 772.5 2125 807.5 {
lab=VDD}
N 2055 660 2055 687.5 {
lab=VSS}
N 2055 542.5 2055 577.5 {
lab=VDD}
N 1940 850 2000 850 {
lab=DN}
N 1830 720 1870 720 {
...
C {devices/vsource.sym} 1580 240 0 0 {name=V1 value="pwl(0 1.8 3.5us 1.8 3.51us 0 7us 0) r=0"}
...
C {DC_DC_Converter/Folded_OPAMP/Folded_OPAMP.sym} 930 610 0 1 {name=XM4}
...
C {DC_DC_Converter/BUFFER/BUFFER_PMOS/BUFFER_P.sym} 2190 900 0 1 {name=X5}
C {devices/lab_wire.sym} 2125 790 0 1 {name=l68 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2125 912.5 0 1 {name=l69 sig_type=std_logic lab=VSS}
C {DC_DC_Converter/BUFFER/BUFFER_PMOS/BUFFER_P.sym} 2120 670 0 1 {name=X6}
C {devices/lab_wire.sym} 2055 560 0 1 {name=l70 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2055 682.5 0 1 {name=l71 sig_type=std_logic lab=VSS}
C {DC_DC_Converter/current_pump/current_pump_for_symbol.sym} 3230 1900 0 1 {name=X7}
C {devices/lab_wire.sym} 1960 850 0 0 {name=l75 sig_type=std_logic lab=DN}
C {devices/lab_wire.sym} 1970 620 0 0 {name=l76 sig_type=std_logic lab=UP}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 870 300 3 0 {name=C5 model=cap_mim_m3_1 W=10 L=19.5 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 960 410 3 0 {name=C3 model=cap_mim_m3_1 W=27 L=27.5 MF=10 spiceprefix=X}
C {sky130_fd_pr/res_generic_m1.sym} 820 410 1 1 {name=R7
W=0.2
L=11200
model=res_generic_m1
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} 1470 280 0 0 {name=R6
W=0.5
L=16
model=res_generic_m1
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} 1340 230 0 0 {name=R1
W=0.2
L=64
model=res_generic_m1
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} 1220 200 0 0 {name=R5
W=0.2
L=912
model=res_generic_m1
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} 1070 210 0 0 {name=R2
W=0.2
L=28800
model=res_generic_m1
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} 1070 350 0 0 {name=R3
W=0.2
L=41600
model=res_generic_m1
mult=1}
C {devices/vsource.sym} 2100 -50 0 0 {name=V10 value=1.8}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1220 270 0 0 {name=C6 model=cap_mim_m3_1 W=27 L=27.5 MF=2 spiceprefix=X}
C {devices/lab_wire.sym} 1140 -30 0 0 {name=l97 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1450 190 0 0 {name=l98 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/Inverter/Inverter.sym} 2440 870 0 1 {name=X3}
C {devices/lab_pin.sym} 2370 920 0 1 {name=l66 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1480 750 0 0 {name=l64 sig_type=std_logic lab=out}
C {devices/lab_wire.sym} 1860 720 0 0 {name=l47 sig_type=std_logic lab=UP}
C {devices/lab_wire.sym} 1860 790 0 0 {name=l67 sig_type=std_logic lab=DN}
C {sky130_fd_pr/nfet_01v8.sym} 530 220 0 0 {name=M10
L=0.15
W=10
nf=1 
mult=150
...
C {devices/lab_wire.sym} 2180 620 0 0 {name=l110 sig_type=std_logic lab=Q}
C {devices/lab_wire.sym} 2490 850 0 0 {name=l111 sig_type=std_logic lab=Q_
}
C {devices/lab_wire.sym} 3300 0 0 0 {name=l79 sig_type=std_logic lab=Q}
C {devices/lab_wire.sym} 2335 750 0 1 {name=l9 sig_type=std_logic lab=VDD}
