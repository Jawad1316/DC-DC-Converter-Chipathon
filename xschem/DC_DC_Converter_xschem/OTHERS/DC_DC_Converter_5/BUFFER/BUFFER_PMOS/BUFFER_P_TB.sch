...
lab=VSS}
N 1210 -150 1210 -120 {}
C {devices/lab_wire.sym} 1260 -70 0 0 {name=l9 sig_type=std_logic lab=OUT}
...
.endc
"}
C {devices/noconn.sym} 1270 -70 0 1 {name=l16}
...
C {devices/res.sym} 1210 -30 0 0 {name=R1
value=10
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 1210 30 0 0 {name=l3 sig_type=std_logic lab=VSS}
...
C {DC_DC_Converter/BUFFER/BUFFER_PMOS/BUFFER_P.sym} 1020 -70 0 0 {name=X1}
C {devices/lab_pin.sym} 1085 -50 0 0 {name=l6 sig_type=std_logic lab=VSS}
