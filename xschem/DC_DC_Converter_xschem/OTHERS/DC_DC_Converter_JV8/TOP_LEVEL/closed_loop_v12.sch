...
C {devices/lab_wire.sym} 200 430 0 1 {name=l35 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 200 590 0 1 {name=l37 sig_type=std_logic lab=VSS}
...
C {DC_DC_Converter/Non_Overlap_Clk/Non_over_clk.sym} 400 770 0 1 {name=xM3}
...
C {DC_DC_Converter/Folded_OPAMP/Folded_OPAMP.sym} 850 560 0 1 {name=XM1}
C {devices/gnd.sym} 1415 7.5 0 0 {name=l25 lab=GND}
