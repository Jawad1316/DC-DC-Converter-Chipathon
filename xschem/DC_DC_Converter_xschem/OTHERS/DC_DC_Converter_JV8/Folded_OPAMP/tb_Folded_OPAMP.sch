...
C {devices/vsource.sym} 50 -60 0 0 {name=V11 value="0.6 ac 1m"}
...
C {devices/vsource.sym} 160 -60 0 0 {name=V2 value="0.6 ac 1m 180"}
...
C {DC_DC_Converter/Folded_OPAMP/Folded_OPAMP.sym} 470 -160 0 0 {name=XM1}
