...
N 860 -480 860 -450 {
lab=VSS}
C {devices/vsource.sym} 530 -490 0 0 {name=V1 value="pulse (0 1.8 0 500p 500p 4n 10n)"}
...
C {OTHERS/DC_DC_Converter_V7/Non_Overlap_Clk/Non_over_clk_V3.sym} 660 -270 0 0 {name=x1}
