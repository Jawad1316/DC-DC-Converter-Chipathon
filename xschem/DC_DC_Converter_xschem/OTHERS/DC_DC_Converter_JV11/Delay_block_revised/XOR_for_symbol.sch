...
C {devices/lab_wire.sym} 1690 470 0 0 {name=l2 sig_type=std_logic lab=AN}
C {devices/lab_wire.sym} 1360 860 0 0 {name=l3 sig_type=std_logic lab=B}
C {devices/lab_wire.sym} 1680 860 0 0 {name=l4 sig_type=std_logic lab=BN}
C {DC_DC_Converter/Delay_block_revised/inverter.sym} 1690 1150 0 0 {name=X1}
C {devices/lab_wire.sym} 1360 470 0 0 {name=l32 sig_type=std_logic lab=A}
C {DC_DC_Converter/Delay_block_revised/inverter.sym} 1680 760 0 0 {name=X3}
C {devices/lab_wire.sym} 1490 370 0 0 {name=l1 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1500 750 0 0 {name=l33 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1490 580 0 0 {name=l34 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1500 960 0 0 {name=l35 sig_type=std_logic lab=VSS}
