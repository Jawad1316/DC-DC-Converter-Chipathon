...
"
spice_ignore=false}
C {devices/vsource.sym} -340 -190 0 0 {name=V5 value="pulse(0 1.8 0 10p 10p 5u 10u 0)"}
C {devices/gnd.sym} -340 -160 0 0 {name=l9 lab=GND}
C {devices/vsource.sym} -260 -70 0 0 {name=V4 value="pulse(0 1.8 2u 10p 10p 5u 10u 0)"}
C {devices/gnd.sym} -260 -40 0 0 {name=l8 lab=GND}
...
C {delay_block_with_less_delay_for_symbol.sym} -1550 760 0 0 {name=X2}
