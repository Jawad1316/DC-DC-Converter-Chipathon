...
C {DC_DC_Converter/Delay_block/delay_block_with_less_delay_for_symbol.sym} 4040 1610 0 1 {name=X3}
C {devices/lab_pin.sym} 2440 690 0 0 {name=l62 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2440 400 0 0 {name=l63 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2620 550 0 0 {name=l64 sig_type=std_logic lab=Q}
...
C {devices/lab_wire.sym} 2260 550 0 0 {name=l73 sig_type=std_logic lab=QD}
C {devices/lab_wire.sym} 2080 920 0 0 {name=l74 sig_type=std_logic lab=Q_D}
C {devices/lab_wire.sym} 1930 550 0 0 {name=l75 sig_type=std_logic lab=UP}
...
C {DC_DC_Converter/Inverter/Inverter.sym} 2210 570 0 1 {name=X8}
C {devices/lab_wire.sym} 2140 492.5 0 1 {name=l72 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2140 612.5 0 1 {name=l77 sig_type=std_logic lab=VSS}
