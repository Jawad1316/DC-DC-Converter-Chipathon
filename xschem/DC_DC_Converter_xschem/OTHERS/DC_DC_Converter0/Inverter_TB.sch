...
C {devices/vsource.sym} -100 170 0 0 {name=V3 value=0.9}
C {devices/gnd.sym} -100 200 0 0 {name=l12 lab=GND}
C {devices/lab_pin.sym} -100 110 0 0 {name=l14 sig_type=std_logic lab=VIN}
...
C {devices/code_shown.sym} 650 30 0 0 {name=SPICE only_toplevel=false value="
.control
...
.endc
"}
C {devices/code.sym} 630 -140 0 0 {name=TT_MODELS
only_toplevel=true
...
C {DC_DC_Converter/BUFFER/Inverter1/inverter1.sym} -200 130 0 0 {name=X2}
