...
N 2400 920 2460 920 {
lab=Q_}
N 1985 590 1985 617.5 {
lab=VSS}
N 1985 472.5 1985 507.5 {
lab=VDD}
...
C {DC_DC_Converter/Folded_OPAMP/Folded_OPAMP.sym} 1690 510 0 1 {name=XM4}
C {DC_DC_Converter/Comparator/Comp_lvt.sym} 550 630 0 1 {name=XM2}
C {devices/lab_wire.sym} 2140 230 0 0 {name=l44 sig_type=std_logic lab=Q}
C {devices/lab_wire.sym} 2140 250 0 0 {name=l45 sig_type=std_logic lab=Q_}
...
C {DC_DC_Converter/Delay_block/delay_block_with_less_delay_for_symbol.sym} 3860 1610 0 1 {name=X3}
C {devices/lab_pin.sym} 2260 690 0 0 {name=l62 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2260 400 0 0 {name=l63 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2440 550 0 0 {name=l64 sig_type=std_logic lab=Q}
C {DC_DC_Converter/Delay_block/delay_block_with_less_delay_for_symbol.sym} 3860 1980 0 1 {name=X4}
C {devices/lab_pin.sym} 2260 1060 0 0 {name=l65 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2260 770 0 0 {name=l66 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2440 920 0 0 {name=l67 sig_type=std_logic lab=Q_}
C {DC_DC_Converter/BUFFER/BUFFER_PMOS/BUFFER_P.sym} 2050 600 0 1 {name=X5}
C {devices/lab_wire.sym} 1985 490 0 1 {name=l68 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1985 612.5 0 1 {name=l69 sig_type=std_logic lab=VSS}
...
C {devices/lab_wire.sym} 2080 550 0 0 {name=l73 sig_type=std_logic lab=QD}
...
C {devices/capa.sym} 1380 800 0 0 {name=C5
m=1
value=20n
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 1380 860 0 1 {name=l72 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1480 750 0 0 {name=l77 sig_type=std_logic lab=CP}
C {devices/vsource.sym} 1440 610 0 0 {name=V10 value=1.8}
C {devices/gnd.sym} 1440 640 0 0 {name=l78 lab=GND}
C {devices/vsource.sym} 1680 990 0 0 {name=V11 value=0}
C {devices/gnd.sym} 1680 1020 0 0 {name=l46 lab=GND}
