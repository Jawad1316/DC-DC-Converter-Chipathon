...
C {DC_DC_Converter/BUFFER/BUFFER_PMOS/BUFFER_P.sym} 40 -30 0 0 {name=X1}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 170 90 0 0 {name=X2}
...
C {DC_DC_Converter/Non_Overlap_Clk/Non_over_clk.sym} 290 440 0 1 {name=XM3}
...
C {DC_DC_Converter/Comparator/Comp_lvt.sym} 440 450 0 1 {name=XM4}
C {DC_DC_Converter/Folded_OPAMP/Folded_OPAMP.sym} 1580 330 0 1 {name=XM1}
