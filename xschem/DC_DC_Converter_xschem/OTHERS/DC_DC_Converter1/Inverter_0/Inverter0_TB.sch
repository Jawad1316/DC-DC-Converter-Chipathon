...
C {devices/vsource.sym} 80 -10 0 0 {name=V3 value=1.8}
C {devices/gnd.sym} 80 20 0 0 {name=l12 lab=GND}
C {devices/lab_pin.sym} 80 -70 0 0 {name=l14 sig_type=std_logic lab=VIN}
...
C {devices/code_shown.sym} 520 20 0 0 {name=SPICE only_toplevel=false value="
.control
...
.endc
"}
C {devices/code.sym} 500 -150 0 0 {name=TT_MODELS
only_toplevel=true
...
C {DC_DC_Converter/Inverter_0/Inverter0.sym} 220 -20 0 0 {name=X1}
