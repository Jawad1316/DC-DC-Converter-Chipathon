...
C {devices/lab_wire.sym} 1520 470 0 0 {name=l2 sig_type=std_logic lab=AN}
C {devices/lab_wire.sym} 1360 860 0 0 {name=l3 sig_type=std_logic lab=B}
C {devices/lab_wire.sym} 1510 860 0 0 {name=l4 sig_type=std_logic lab=BN}
C {devices/lab_wire.sym} 1360 470 0 0 {name=l32 sig_type=std_logic lab=A}
C {devices/lab_wire.sym} 1420 410 0 0 {name=l1 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1430 790 0 0 {name=l33 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1420 540 0 0 {name=l34 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1430 920 0 0 {name=l35 sig_type=std_logic lab=VSS}
...
C {DC_DC_Converter/Inverter/Inverter.sym} 1350 490 0 0 {name=X10}
C {DC_DC_Converter/Inverter/Inverter.sym} 1360 880 0 0 {name=X1}
