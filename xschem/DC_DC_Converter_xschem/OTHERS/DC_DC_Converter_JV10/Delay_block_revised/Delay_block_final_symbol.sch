...
N 1490 400 1550 400 {
lab=D2}
N 150 387.5 150 447.5 {
lab=VSS}
N 150 250 150 310 {
lab=VDD}
N 190 347.5 240 347.5 {
lab=#net2}
N 420 347.5 470 347.5 {
lab=SL1}
N 60 347.5 110 347.5 {
lab=D1}
N 740 -480 810 -480 {
lab=SL1}
N 740 -400 810 -400 {
...
N 1100 420 1100 430 {
lab=D1}
N 330 387.5 330 447.5 {
lab=VSS}
N 330 250 330 310 {
lab=VDD}
N 370 347.5 420 347.5 {
lab=SL1}
N 240 347.5 290 347.5 {
lab=#net2}
N 1380 440 1380 500 {
lab=VSS}
N 1380 302.5 1380 362.5 {
lab=VDD}
N 2130 460 2130 520 {
lab=VSS}
N 2130 322.5 2130 382.5 {
lab=VDD}
...
C {devices/lab_pin.sym} 150 417.5 0 0 {name=l24 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 150 280 0 0 {name=l25 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 90 347.5 0 0 {name=l28 sig_type=std_logic lab=D1}
C {devices/lab_wire.sym} 460 347.5 0 0 {name=l29 sig_type=std_logic lab=SL1}
C {devices/iopin.sym} 460 347.5 0 0 {name=p2 lab=SL1}
...
C {devices/lab_wire.sym} 1500 400 0 0 {name=l36 sig_type=std_logic lab=D2}
C {devices/lab_wire.sym} 2260 420 0 0 {name=l37 sig_type=std_logic lab=D3}
...
C {DC_DC_Converter/Inverter/Inverter.sym} 80 367.5 0 0 {name=X3}
C {devices/lab_pin.sym} 330 417.5 0 0 {name=l10 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 330 280 0 0 {name=l12 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/Inverter/Inverter.sym} 260 367.5 0 0 {name=X2}
C {devices/lab_pin.sym} 1380 470 0 0 {name=l14 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1380 332.5 0 0 {name=l15 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/Inverter/Inverter.sym} 1310 420 0 0 {name=X1}
C {devices/lab_pin.sym} 2130 490 0 0 {name=l17 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2130 352.5 0 0 {name=l26 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/Inverter/Inverter.sym} 2060 440 0 0 {name=X4}
