...
N 1680 -330 1680 -140 {
lab=Enable}
N 2727.5 -5 2727.5 25 {
lab=VDD}
N 2867.5 175 2907.5 175 {
lab=Q1}
N 2737.5 325 2737.5 355 {
lab=VSS}
N 2547.5 115 2597.5 115 {
lab=#net10}
N 2547.5 155 2597.5 155 {
lab=#net11}
N 2547.5 205 2597.5 205 {
lab=#net12}
N 2740 490 2740 520 {
lab=VDD}
N 2880 670 2920 670 {
...
N 2195 695 2330 695 {
lab=VSS}
N 2195 752.5 2195 767.5 {
lab=VDD}
N 2195 752.5 2330 752.5 {
lab=VDD}
N 2195 850 2195 865 {
lab=VSS}
N 2195 865 2330 865 {
lab=VSS}
N 2135 152.5 2235 152.5 {
lab=SL2}
N 2135 287.5 2235 287.5 {
lab=SL3}
N 2135 20 2235 20 {
lab=SL1}
N 2290 230 2290 245 {
lab=VDD}
N 2290 327.5 2290 342.5 {
lab=VSS}
N 2290 95 2290 110 {
lab=VDD}
N 2290 192.5 2290 207.5 {
lab=VSS}
N 2290 -37.5 2290 -22.5 {
lab=VDD}
N 2290 60 2290 75 {
lab=VSS}
N 2457.5 115 2547.5 115 {
lab=#net10}
N 2457.5 20 2457.5 115 {
lab=#net10}
N 2335 20 2457.5 20 {
lab=#net10}
N 2335 152.5 2507.5 152.5 {
lab=#net11}
N 2507.5 155 2547.5 155 {
lab=#net11}
N 2507.5 152.5 2507.5 155 {
lab=#net11}
N 2475 205 2547.5 205 {
lab=#net12}
N 2475 205 2475 280 {
lab=#net12}
N 2475 280 2475 282.5 {
lab=#net12}
N 2475 282.5 2475 285 {
lab=#net12}
N 2475 285 2475 287.5 {
lab=#net12}
N 2335 287.5 2475 287.5 {
lab=#net12}
...
C {DC_DC_Converter/Inverter/Inverter.sym} 1940 -290 0 0 {name=X9}
C {DC_DC_Converter/Inverter/Inverter.sym} 1940 -100 0 0 {name=X10}
C {devices/lab_wire.sym} 2090 -120 0 0 {name=l86 sig_type=std_logic lab=Q2}
...
C {devices/lab_pin.sym} 2010 -190 0 0 {name=l94 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2090 -310 0 0 {name=l79 sig_type=std_logic lab=Q1}
...
C {devices/lab_pin.sym} 2010 -380 0 0 {name=l36 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/Delay_block_revised/Delay_block_final_symbol.sym} 3157.5 295 0 1 {name=x1}
C {devices/lab_pin.sym} 2727.5 5 0 0 {name=l68 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 2737.5 335 0 0 {name=l69 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 2897.5 175 0 0 {name=l70 sig_type=std_logic lab=Q1}
C {devices/lab_wire.sym} 2190 20 0 0 {name=l71 sig_type=std_logic lab=SL1}
C {devices/lab_wire.sym} 2190 152.5 0 0 {name=l72 sig_type=std_logic lab=SL2}
C {devices/lab_wire.sym} 2182.5 287.5 0 0 {name=l73 sig_type=std_logic lab=SL3}
C {DC_DC_Converter/Delay_block_revised/Delay_block_final_symbol.sym} 3170 790 0 1 {name=x2}
C {devices/lab_pin.sym} 2740 500 0 0 {name=l74 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 2750 830 0 0 {name=l75 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 2910 670 0 0 {name=l76 sig_type=std_logic lab=Q2}
C {devices/lab_wire.sym} 2090 470 0 0 {name=l77 sig_type=std_logic lab=SL1_B}
C {devices/lab_wire.sym} 2070 640 0 0 {name=l78 sig_type=std_logic lab=SL2_B}
C {devices/lab_wire.sym} 2090 810 0 0 {name=l80 sig_type=std_logic lab=SL3_B}
...
C {DC_DC_Converter/Inverter/Inverter.sym} 2400 660 0 1 {name=X4}
C {devices/lab_pin.sym} 2330 570 0 1 {name=l83 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/Inverter/Inverter.sym} 2400 830 0 1 {name=X5}
C {devices/lab_pin.sym} 2330 740 0 1 {name=l92 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 2330 870 0 1 {name=l93 sig_type=std_logic lab=VSS}
C {DC_DC_Converter/Current_pump_mirror/current_pump_mirror_three_brunch_symbol.sym} 690 960 0 1 {name=x3}
C {devices/lab_pin.sym} 2330 700 0 1 {name=l82 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2330 530 0 1 {name=l85 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1420 490 0 1 {name=l95 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1620 820 0 1 {name=l99 sig_type=std_logic lab=SL1_B}
C {devices/lab_wire.sym} 1620 850 0 1 {name=l100 sig_type=std_logic lab=SL2_B}
C {devices/lab_wire.sym} 1620 880 0 1 {name=l101 sig_type=std_logic lab=SL3_B}
C {devices/lab_pin.sym} 1410 1030 0 1 {name=l102 sig_type=std_logic lab=VSS}
C {devices/isource.sym} 1250 -210 0 0 {name=I4 value=1m}
C {devices/lab_wire.sym} 1250 -160 0 1 {name=l104 sig_type=std_logic lab=IBIAS5}
C {devices/lab_pin.sym} 1250 -270 0 0 {name=l103 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1370 500 0 0 {name=l105 sig_type=std_logic lab=IBIAS5}
C {devices/lab_wire.sym} 1620 640 0 1 {name=l106 sig_type=std_logic lab=SL1}
C {devices/lab_wire.sym} 1620 670 0 1 {name=l107 sig_type=std_logic lab=SL2}
C {devices/lab_wire.sym} 1620 700 0 1 {name=l108 sig_type=std_logic lab=SL3}
C {devices/lab_wire.sym} 1150 760 0 0 {name=l109 sig_type=std_logic lab=out}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 2330 720 0 1 {name=X6}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 2330 890 0 1 {name=X7}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 2330 550 0 1 {name=X8}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 2425 232.5 0 1 {name=X11}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 2425 367.5 0 1 {name=X12}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 2425 100 0 1 {name=X13}
C {devices/lab_pin.sym} 2290 337.5 0 0 {name=l110 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2290 235 0 0 {name=l111 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 2290 202.5 0 0 {name=l112 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2290 100 0 0 {name=l113 sig_type=std_logic lab=VDD}
