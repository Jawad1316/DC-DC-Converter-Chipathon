...
C {devices/lab_wire.sym} 1090 -500 0 0 {name=l1 sig_type=std_logic lab=IBIAS1}
C {devices/lab_wire.sym} 1090 -470 0 0 {name=l5 sig_type=std_logic lab=IBIAS2}
C {devices/lab_wire.sym} 1830 -920 0 0 {name=l52 sig_type=std_logic lab=IBIAS1}
C {devices/isource.sym} 1830 -850 0 0 {name=I2 value=50u}
C {devices/lab_wire.sym} 1930 -920 0 0 {name=l90 sig_type=std_logic lab=IBIAS2}
...
device=resistor
m=1}
C {DC_DC_Converter/TOP_LEVEL/Top_Final/Top_1_PEX.sym} 1960 -250 0 0 {name=XTOPA1}
