...
N 2160 310 2220 310 {
lab=2}
N 2347.5 100 2407.5 100 {
lab=Q1}
N 2347.5 290 2407.5 290 {
lab=Q2}
N 2270 350 2270 370 {
lab=VSS}
N 2270 210 2270 230 {
...
N 1670 970 1750 970 {
lab=#net11}
N 1805 867.5 1805 927.5 {
lab=VDD}
N 1805 1010 1805 1070 {
lab=VSS}
N 1850 970 1880 970 {
lab=#net12}
N 1600 600 1670 600 {
lab=Q1D}
N 1725 640 1725 677.5 {
lab=VSS}
N 1725 527.5 1725 557.5 {
lab=VDD}
N 1500 970 1570 970 {
lab=Q2D}
N 1625 1010 1625 1047.5 {
lab=VSS}
N 1625 897.5 1625 927.5 {
lab=VDD}
N 1250 1010 1250 1060 {
lab=VSS}
N 1250 1010 1250 1060 {
lab=VSS}
N 1040 650 1040 700 {
...
C {devices/lab_wire.sym} 1890 280 0 1 {name=l48 sig_type=std_logic lab=IBIAS4}
C {devices/lab_wire.sym} 1870 280 0 0 {name=l49 sig_type=std_logic lab=IBIAS3}
C {devices/lab_pin.sym} 1810 280 0 0 {name=l50 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1850 70 0 0 {name=l51 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1710 190 1 0 {name=l53 sig_type=std_logic lab=VH}
C {devices/lab_pin.sym} 1710 210 3 0 {name=l54 sig_type=std_logic lab=VL}
C {DC_DC_Converter/Comparator_Pair/cmp_pair.sym} 1720 250 0 0 {name=XM1}
C {devices/lab_wire.sym} 2000 170 0 0 {name=l47 sig_type=std_logic lab=1}
C {devices/lab_wire.sym} 2000 190 0 0 {name=l87 sig_type=std_logic lab=2}
C {devices/gnd.sym} 1450 -160 0 0 {name=l58 lab=GND}
C {devices/isource.sym} 1450 -190 0 0 {name=I2 value=50u}
C {devices/isource.sym} 1540 -190 0 0 {name=I3 value=50u}
C {devices/gnd.sym} 1540 -160 0 0 {name=l60 lab=GND}
C {devices/lab_wire.sym} 1450 -250 0 0 {name=l59 sig_type=std_logic lab=IBIAS3}
C {devices/lab_wire.sym} 1540 -240 0 1 {name=l61 sig_type=std_logic lab=IBIAS4}
C {devices/lab_pin.sym} 2270 370 0 0 {name=l84 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 2387.5 290 0 0 {name=l86 sig_type=std_logic lab=Q2}
C {devices/lab_wire.sym} 2190 120 0 0 {name=l64 sig_type=std_logic lab=1}
C {devices/lab_wire.sym} 2190 310 0 0 {name=l88 sig_type=std_logic lab=2}
C {devices/lab_wire.sym} 2050 80 0 0 {name=l91 sig_type=std_logic lab=Enable}
C {devices/lab_pin.sym} 2270 210 0 0 {name=l94 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2387.5 100 0 0 {name=l79 sig_type=std_logic lab=Q1}
C {devices/lab_pin.sym} 2270 180 0 0 {name=l52 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2270 20 0 0 {name=l55 sig_type=std_logic lab=VDD}
C {devices/vsource.sym} 1250 -190 0 0 {name=V7 value=1.05}
C {devices/gnd.sym} 1250 -160 0 0 {name=l56 lab=GND}
C {devices/lab_pin.sym} 1250 -250 0 0 {name=l57 sig_type=std_logic lab=VH}
C {devices/vsource.sym} 1330 -190 0 0 {name=V8 value=0.95}
C {devices/gnd.sym} 1330 -160 0 0 {name=l65 lab=GND}
C {devices/lab_pin.sym} 1330 -250 0 0 {name=l66 sig_type=std_logic lab=VL}
C {devices/gnd.sym} 1150 -160 0 0 {name=l89 lab=GND}
C {devices/lab_pin.sym} 1150 -250 0 0 {name=l90 sig_type=std_logic lab=Enable}
C {devices/vsource.sym} 1150 -190 0 0 {name=V10 value=1.8}
C {DC_DC_Converter/Delay_block_revised/AND_GATE/AND.sym} 2200 170 0 0 {name=X_AND1}
C {DC_DC_Converter/Delay_block_revised/AND_GATE/AND.sym} 2200 360 0 0 {name=X_AND2}
C {devices/lab_pin.sym} 2000 740 0 0 {name=l67 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2000 450 0 0 {name=l68 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2197.5 600 0 0 {name=l69 sig_type=std_logic lab=Q1}
C {devices/lab_pin.sym} 2010 1110 0 0 {name=l70 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2010 820 0 0 {name=l71 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1537.5 970 0 0 {name=l72 sig_type=std_logic lab=Q2D}
C {devices/lab_wire.sym} 2207.5 970 0 0 {name=l73 sig_type=std_logic lab=Q2}
C {DC_DC_Converter/Delay_block_revised/delay_block_stage1.sym} 3600 1660 0 1 {name=XD1}
C {DC_DC_Converter/Delay_block_revised/delay_block_stage1.sym} 3610 2030 0 1 {name=XD2}
C {devices/lab_wire.sym} 1347.5 890 0 0 {name=l77 sig_type=std_logic lab=Q1D}
C {DC_DC_Converter/Delay_block_revised/Inverter_0/Inverter0.sym} 2070 1090 0 1 {name=X4}
C {devices/lab_pin.sym} 1805 897.5 0 0 {name=l63 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1805 1040 0 0 {name=l75 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1630 600 1 0 {name=l78 sig_type=std_logic lab=Q1D}
C {devices/lab_wire.sym} 1342.5 760 0 0 {name=l74 sig_type=std_logic lab=Q2D}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 1860 680 0 1 {name=X5}
C {devices/lab_wire.sym} 1725 665 0 1 {name=l81 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1725 545 0 1 {name=l83 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/BUFFER/BUFFER_NMOS/BUFFER_N.sym} 1760 1050 0 1 {name=X6}
C {devices/lab_wire.sym} 1625 1035 0 1 {name=l85 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1625 915 0 1 {name=l92 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1250 1040 0 1 {name=l80 sig_type=std_logic lab=VSS}
C {devices/vsource.sym} 1040 730 0 0 {name=V11 value=1.8}
C {devices/gnd.sym} 1040 760 0 0 {name=l104 lab=GND}
C {devices/isource.sym} 1250 660 0 0 {name=I4 value=40m}
C {devices/lab_wire.sym} 1220 820 0 0 {name=l82 sig_type=std_logic lab=out}
C {sky130_fd_pr/pfet_01v8.sym} 1270 760 0 1 {name=M1
L=0.15
W=10
nf=1
mult=450
...
C {sky130_fd_pr/nfet_01v8.sym} 1270 890 0 1 {name=M4
L=0.15
W=10
nf=1 
mult=150
...
C {devices/isource.sym} 1250 980 0 0 {name=I5 value=40m}
C {devices/lab_wire.sym} 1200 760 0 1 {name=l62 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 1202.5 890 0 1 {name=l76 sig_type=std_logic lab=VSS}
