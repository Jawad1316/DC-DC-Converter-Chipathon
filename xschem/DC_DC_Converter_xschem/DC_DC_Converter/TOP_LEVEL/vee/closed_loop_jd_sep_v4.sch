...
C {devices/vsource.sym} 880 -210 0 0 {name=V7 value=1.08}
...
C {devices/lab_wire.sym} 2270 700 0 1 {name=l103 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 2470 490 0 0 {name=l107 sig_type=std_logic lab=SL1}
C {devices/lab_wire.sym} 2480 560 0 0 {name=l108 sig_type=std_logic lab=SL1_B}
C {devices/lab_wire.sym} 2590 -90 1 0 {name=l70 sig_type=std_logic lab=SL1}
C {DC_DC_Converter/Inverter/Inverter.sym} 2790 -20 0 1 {name=X4}
C {devices/lab_pin.sym} 2720 -110 0 1 {name=l71 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 2600 60 0 1 {name=l75 sig_type=std_logic lab=VSS}
C {devices/vcvs.sym} 2590 -20 0 1 {name=E1 value=1}
C {devices/lab_pin.sym} 2720 20 0 1 {name=l78 sig_type=std_logic lab=VSS}
C {DC_DC_Converter/Delay_block_revised/delay_block_250.sym} 1840 90 0 1 {name=x3}
C {devices/lab_pin.sym} 2980 170 0 1 {name=l68 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2970 -240 0 1 {name=l69 sig_type=std_logic lab=VDD}
C {DC_DC_Converter/Delay_block_revised/delay_block_250.sym} 1780 700 0 1 {name=x1}
C {devices/lab_pin.sym} 2920 780 0 1 {name=l72 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 2910 370 0 1 {name=l73 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 2660 520 1 0 {name=l82 sig_type=std_logic lab=SL1_B}
C {devices/lab_pin.sym} 2670 670 0 1 {name=l83 sig_type=std_logic lab=VSS}
C {devices/vcvs.sym} 2660 590 0 1 {name=E2 value=1}
C {devices/lab_wire.sym} 2100 520 0 0 {name=l74 sig_type=std_logic lab=out}
C {devices/lab_wire.sym} 3160 570 0 0 {name=l85 sig_type=std_logic lab=Q1}
C {devices/lab_wire.sym} 3220 -40 0 0 {name=l93 sig_type=std_logic lab=Q2}
C {DC_DC_Converter/current_pump/current_pump_for_symbol.sym} 3820 1670 0 1 {name=X3}
C {devices/vsource.sym} 2070 400 0 0 {name=V12 value=1.8}
C {devices/gnd.sym} 2070 430 0 0 {name=l76 lab=GND}
