...
lab=VSS}
C {DC_DC_Converter/current_pump/current_pump_for_symbol.sym} 1330 -1140 0 0 {name=X1}
...
C {devices/lab_wire.sym} 3070 -2290 0 0 {name=l2 sig_type=std_logic lab=OUT}
