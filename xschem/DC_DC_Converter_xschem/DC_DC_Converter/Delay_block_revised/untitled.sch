...
N 460 -430 460 -420 {
lab=A}
C {DC_DC_Converter/Delay_block_revised/AND_GATE/AND.sym} 820 -370 0 0 {name=X_AND1}
...
C {devices/lab_wire.sym} 997.5 -440 0 0 {name=l3 sig_type=std_logic lab=OUT}
C {devices/lab_wire.sym} 825 -460 0 0 {name=l4 sig_type=std_logic lab=A}
C {devices/lab_wire.sym} 825 -420 0 0 {name=l5 sig_type=std_logic lab=B}
