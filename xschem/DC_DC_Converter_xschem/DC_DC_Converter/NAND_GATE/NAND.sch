...
C {devices/lab_wire.sym} 800 -280 0 1 {name=l7 sig_type=std_logic lab=OUT}
...
C {devices/lab_wire.sym} 620 -90 0 1 {name=l13 sig_type=std_logic lab=VSS}
